...
2. Установка postgresql в среду разработки:
  2.1. В папке с проектом есть папка backup_database там файл shop_lisa.backup
  2.2. открываем pgAdmin 4 
  2.3. создаем базу данных с именем shop_lisa
  2.4. делаем востановление базы данных 
